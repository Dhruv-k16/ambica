            ...
            <div className="text-center mt-12">
              <Link to="/showcase">
                <Button
                  ...
                  size="lg"
                  className="rounded-full bg-primary text-white hover:bg-primary/90 shadow-lg hover:shadow-xl transition-all duration-300 px-8"
                >
                  View Full Portfolio
                </Button>
              </Link>
          ...
          >
            ...
            <Link to="/contact">
              <Button
                ...
                size="lg"
                className="rounded-full bg-primary text-white hover:bg-primary/90 shadow-lg hover:shadow-xl transition-all duration-300 px-8 py-6 text-lg"
              >
                Get in Touch
              </Button>
            </Link>
